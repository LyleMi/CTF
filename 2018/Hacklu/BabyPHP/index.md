After access this site, we will see [source code](https://github.com/LyleMi/CTF/blob/master/2018/Hacklu/BabyPHP/index.php) here, we can know this is a typical PHP trick challenge.
